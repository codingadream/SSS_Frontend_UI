...
import type { AccountsResponse } from "../types/types.ts";
import axios from "axios";
import toast from "react-hot-toast";
import { callSync } from "../helpers.ts";
  ...
  return (
    <Box
      ...
      `,
        ...
        backgroundPosition:
          "0 0, -100px -100px, calc(100% + 100px) calc(100% + 100px), center center",
      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 1, pr: { md: 4 } }}>
            ...
            >
              With personalized insights and secure tools, we help you track
              every expense, plan for the future, and build lasting financial
              confidence.
            </Typography>
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center" }}>
            ...
            <Typography variant="body2" sx={{ opacity: 0.8, mt: 1 }}>
              By logging in, you agree to Commerce Bank's Terms of Use and
              Privacy Policy.
            </Typography>
          </Box>
        </Container>
