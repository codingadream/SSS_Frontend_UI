  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", flexGrow: 1, pt: 8 }}>
        ...
        {/* Main content */}
        {loading || !transactionsData || !accountsData || !userData ? (
          <LoadingSpinner />
        ) : (
          <Box
            component="main"
                          ...
                          >
                            ...
                            >
                              ...
                              {maxSpending.toLocaleString(
                                "en-us" /*TODO add limit */
                              )}
                            </Typography>
                            {spendingData.some(
                              (d) => d.spending > maxSpending
                            ) && ( // TODO replace spendingmax with limit
                              <Typography
                                variant="caption"
                                sx={{
                                  fontSize: "10px",
